 ...
 * @returns Mutation for clearing change history of current database
 */
 ...
 * @returns Mutation for clearing all change history data
 */
 ...
 * @returns Object with change history refresh utilities
 */
